...
import ChequeVoucherPreviewSection from "@/components/voucher/voucher-view/ChequeVoucher/PreviewSection";
import type { PrintableData } from "@/components/voucher/voucher-view/ChequeVoucher/types";
...
export default function ChequeVoucherListPage() {
  ...
  const handleCancelVoucher = useCallback(
    async (voucherId: number) => {
      ...
      try {
        const res = await fetch(`/api/accountant/vouchers/${voucherId}/cancel`, {
          method: "POST",
    ...
    return (
      <div className="inline-flex rounded-xl border border-gray-200 bg-white p-1">
        <button
          ...
          className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-semibold transition ${viewMode === "cards" ? "bg-[#7B0F2B] text-white" : "text-gray-700 hover:bg-gray-50"
            }`}
        ...
        <button
          ...
          className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-semibold transition ${viewMode === "table" ? "bg-[#7B0F2B] text-white" : "text-gray-700 hover:bg-gray-50"
            }`}
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-[#7B0F2B] via-[#8B1535] to-[#5E0C20] text-white px-6 py-8">
            ...
            <div className="relative flex items-center justify-between gap-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h1 className="text-2xl font-bold tracking-tight">Cheque Vouchers</h1>
                  <p className="text-white/80 text-sm mt-0.5">Search, view, and edit cheque voucher transactions</p>
                </div>
              </div>
              ...
              <div className="p-6 bg-gray-50/50 border-b border-gray-100">
                <div className="flex items-center justify-between mb-4 gap-3">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Use search, status, and sorting to find vouchers quickly</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <div className="relative">
                        ...
                        <input
                          type="text"
                          placeholder="Voucher no., payee, status, amount, check no..."
                          value={searchDraft}
                ...
                <>
                  <div className="flex items-center justify-between mb-4">
                    <p className="text-sm text-gray-600">
                      Showing <span className="font-semibold text-gray-900">{computed.length}</span> cheque voucher(s)
                    </p>
                  </div>
                      ...
                      {computed.map((voucher) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {/* Bottom colored block - matching Cash Voucher design */}
