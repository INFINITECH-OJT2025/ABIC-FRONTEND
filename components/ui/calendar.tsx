  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex mb-1",
        head_cell:
          "text-neutral-500 w-9 font-normal text-[0.8rem] flex items-center justify-center",
        ...
        day_selected:
          "bg-[#7a0f1f] text-white hover:bg-[#7a0f1f] hover:text-white focus:bg-[#7a0f1f] focus:text-white",
